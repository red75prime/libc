...
pub const __SIZEOF_PTHREAD_COND_COMPAT_T: usize = 48;
...
// constants are copied from uclibc/arm/mod.rs and fixed manually
...
pub const O_DSYNC: ::c_int = 0x101000;
...
pub const SYS_gettid: ::c_int = 0xb2;
